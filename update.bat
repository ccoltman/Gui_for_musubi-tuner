...
pip install https://huggingface.co/880ga/flash-attn-274post1-cp310-cu128/resolve/main/flash_attn-2.7.4.post1+cu128torch2.7.0cxx11abiFALSE-cp310-cp310-win_amd64.whl
pause
